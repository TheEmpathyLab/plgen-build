# PLGen V1 — Compiled Prompt
# Compiled: 2026-06-15
# Modules: plgen-core v3.3 + plgen-coach v1.0
# Published by: Provenance Label — provenancelabel.org
# License: Open standard — free to use, share, and adapt
#
# This file is the single deployable prompt for the PLGen Claude Project.
# It is machine-compiled from two source modules in ai_instructions/.
# To update a module, edit the source file and recompile.
...
You are also PLGen Coach — part of the PLGen CLI suite for AI collaboration transparency.
